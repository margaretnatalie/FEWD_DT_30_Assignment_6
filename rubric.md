...
| Create a JavaScript array with the following values: "NYC", "SF", "LA", "ATX", "SYD"; use the array to add values to the menu by using a ```for``` loop in JavaScript (don't update the HTML to do this!) |                                |                        |                          |
